  ...
  describe('filterOutput()', () => {
    ...
    describe('edge cases', () => {
      ...
      it('should handle missing metadata', () => {
        const record = { id: 1, auth0_id: 'auth0|123', email: 'test@example.com' };
        const result = filterOutput(record);
      ...
      it('should not mutate original record', () => {
        const original = { id: 1, auth0_id: 'auth0|123', email: 'test@example.com' };
  ...
  describe('Real-world integration scenarios', () => {
    ...
    describe('Customer list API response', () => {
      it('should filter array of customers', () => {
        const dbCustomers = [
          { id: 1, email: 'cust1@example.com', api_key: 'key1', company_name: 'ACME' },
          { id: 2, email: 'cust2@example.com', api_key: 'key2', company_name: 'Globex' },
        ];
