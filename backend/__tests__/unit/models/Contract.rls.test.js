...
describe('Contract Model - RLS Tests', () => {
  ...
  describe('_buildRLSFilter()', () => {
    ...
    test('should return customer filter for own_contracts_only policy', () => {
    ...
    test('should return security failsafe when userId missing for own_contracts_only', () => {
  ...
  describe('findById() with RLS', () => {
    ...
    test('should apply own_contracts_only RLS policy (customer)', async () => {
      const mockContract = { id: 1, contract_number: 'CNT-001', customer_id: 99 };
      db.query.mockResolvedValueOnce({ rows: [mockContract] });
