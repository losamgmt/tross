...
/// DESIGN NOTE: This const exists for Dart's test framework constraint.
///
/// Dart processes group()/test()/testWidgets() declarations at PARSE TIME
/// before setUpAll() runs. This means we cannot use dynamic registry access
/// for test group declarations like:
///   `for (entity in allKnownEntities) { testWidgets('$entity - ...', ...) }`
///
/// This static const enables per-entity test granularity (each entity gets
/// its own test in reports) while the parity test validates sync.
///
/// AUTO-SYNCED: This const is auto-generated by `npm run sync:metadata`.
